...
public class LinuxHack {
    public static Object hack() throws Exception {
        ...
        Launch.UNSAFE.putLong(JPLISAgent + 8, native_jvmtienv);
        ...
        try {
            ...
            inst = constructor.newInstance(JPLISAgent, true, false);
