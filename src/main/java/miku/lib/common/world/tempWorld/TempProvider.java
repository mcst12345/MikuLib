...
import miku.lib.common.world.tempWorld.biome.TempBiomeProvider;
...
public class TempProvider extends WorldProvider {

    @NotNull
    @Override
    public DimensionType getDimensionType() {
        return TempWorld.Temp;
    }
    ...
    @Override
    protected void init() {
        this.biomeProvider = new TempBiomeProvider();
    ...
    @Override
    public boolean canMineBlock(@Nonnull net.minecraft.entity.player.EntityPlayer player, @Nonnull BlockPos pos) {
        return false;
    }
