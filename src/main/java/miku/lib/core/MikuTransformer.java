...
public class MikuTransformer implements IClassTransformer {
    ...
    private static boolean isBadInject(String s){//Holy Shit.
        return s.contains("[setHealth]") || s.contains("[damageEntity]") || s.contains("[getHealth]") || s.contains("[getMaxHealth]") || s.contains("[setDead]") || s.contains("[attackEntityFrom]") ||
                ...
                s.contains("func_174812_G") || s.contains("func_70106_y") || s.contains("func_70097_a") || s.contains("func_71019_a") || s.contains("func_71040_bB") || s.contains("func_145779_a") || s.contains("func_70099_a") || s.contains("func_70089_S") || s.contains("func_70609_aI") || s.contains("func_130011_c") ||
                s.contains("func_110143_aJ") || s.contains("func_70606_j") || s.contains("func_70645_a") || s.contains("func_70665_d") || s.contains("func_110138_aP") || s.contains("func_70103_a") || s.contains("func_70610_aX") || s.contains("func_70659_e") || s.contains("func_70689_ay") || s.contains("func_70652_k") ||
                s.contains("func_70071_h_") || s.contains("func_70014_b") || s.contains("func_70037_a") || s.contains("func_70636_d") || s.contains("func_70692_ba") || s.contains("func_70626_be") || s.contains("func_184582_a") || s.contains("func_184201_a") || s.contains("func_174820_d") || s.contains("func_94061_f") ||
                s.contains("func_72838_d") || s.contains("func_72923_a") || s.contains("func_72847_b") || s.contains("func_72900_e") || s.contains("func_72973_f") || s.contains("func_72954_a") || s.contains("func_72848_b") || s.contains("func_72939_s") || s.contains("func_184147_l") || s.contains("func_72870_g") ||
                s.contains("func_72866_a") || s.contains("func_72835_b") || s.contains("func_72910_y") || s.contains("func_175650_b") || s.contains("func_175681_c");
    }
