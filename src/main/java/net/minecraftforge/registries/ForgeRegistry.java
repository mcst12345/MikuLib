...
public class ForgeRegistry<V extends IForgeRegistryEntry<V>> implements IForgeRegistryInternal<V>, IForgeRegistryModifiable<V> {
    ...
    public void validateContent(ResourceLocation registryName) {
        try {
    ...
    public RegistryEvent.Register<V> getRegisterEvent(ResourceLocation name) {
        return new RegistryEvent.Register<V>(name, this);
    }

    public void dump(ResourceLocation name) {
    ...
    public boolean markDummy(ResourceLocation key, int id) {
